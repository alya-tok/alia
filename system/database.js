module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Whatsapp bot by'
      if (!('sk_author' in setting)) setting.sk_author = '@alya'
