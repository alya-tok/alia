      ...
      try {
         ...
         if (text) {
            ...
            if (text.match('getstickerpack.com')) {
               ...
               await client.reply(m.chat, Func.texted('bold', `✅ Done, semua stiker berhasil dikonversi.`), m)
            } else {
               let rows = []
               ...
               client.sendList(m.chat, '', `Menampilkan hasil pencarian untuk : “${text}”, pilih stiker yang ingin Anda ubah. 🍟`, '', 'Tap!', [{
                  rows
               }], m)
            }
         } else {
