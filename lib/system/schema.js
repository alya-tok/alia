module.exports = (m, env) => {
  ...
  if (setting) {
    ...
    if (!('sk_author' in setting)) setting.sk_author = '© alia'
    ...
    if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/96fc4efa8f75965d757f6.jpg'
    if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/GfBgnkz1lAs7NUk7lnzCDk'
  } else {
    global.db.setting = {
      autodownload: true,
      antispam: false,
      ...
      msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.alyachan.dev\n◦ *Source* : https://github.com/alya-tok/alia\n\nIf you find an error or want to upgrade premium plan contact the owner.',
      style: 4,
      cover: 'https://telegra.ph/file/96fc4efa8f75965d757f6.jpg',
