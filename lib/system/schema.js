module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = global.packname
      if (!('sk_author' in setting)) setting.sk_author = global.packauthor
      ...
      global.db.setting = {
         ...
         pluginDisable: [],
         groupmode: false,
         sk_pack: global.packname,
         sk_author: global.packauthor,
         self: false,
         noprefix: false,
         multiprefix: true,
         prefix: ['.', '#', '!', '/'],
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6285815700861', '6281252848955'],
         lastReset: new Date * 1,
         msg: 'Hi +tag\nSaya adalah sebuah sistem otomatis (WhatsApp Bot) yang dapat membantu untuk melakukan sesuatu, mencari dan mendapatkan data/informasi hanya melalui WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.alyachan.biz.id\n◦ *Source* : https://github.com/alya-tok/alya-bot\n\nJika kamu menemukan kesalahan atau ingin meningkatkan paket premium, hubungi owner.',
         style: 2,
         cover: 'https://telegra.ph/file/e0b576f87e2c1a7002c05.jpg',
